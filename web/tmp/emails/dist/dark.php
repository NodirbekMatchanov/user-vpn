<!DOCTYPE html>
<html lang="ru" style="box-sizing: border-box; max-width: 100%; outline: none;">
<head style="box-sizing: border-box; max-width: 100%; outline: none;">
	<meta charset="UTF-8" style="box-sizing: border-box; max-width: 100%; outline: none;">
	<meta name="viewport" content="width=device-width, initial-scale=1.0" style="box-sizing: border-box; max-width: 100%; outline: none;">
	
</head>
<?php $class = '_dark' ?>
<?php $root = 'https://vpnmax.webresult.online/' ?>

<body class="_dark" style="box-sizing: border-box; color: #fff; font-family: Arial, sans-serif; font-weight: 400; line-height: 1.1; margin: 0; max-width: 100%; outline: none; padding: 0;">
	<!-- все картинки должны быть с полным путем к сайту -->

	<div class="wrap" style="background: #232323; box-sizing: border-box; margin-left: auto; margin-right: auto; max-width: 600px; outline: none;">
...
<div class="content" style="box-sizing: border-box; font-size: 26px; max-width: 100%; outline: none; padding: 45px 50px 70px;">
	<h2 class="title" style="box-sizing: border-box; font-size: 32px; font-weight: 600; line-height: lh(40.25, 35); margin-top: 0; max-width: 100%; outline: none;">Здравствуйте,</h2>
	<p style="box-sizing: border-box; margin-top: 0; max-width: 100%; outline: none;">Ваш аккаунт на сайте «VPN MAX»<br style="box-sizing: border-box; max-width: 100%; outline: none;"> был успешно создан.</p>
	<br style="box-sizing: border-box; max-width: 100%; outline: none;">
	<p style="box-sizing: border-box; margin-top: 0; max-width: 100%; outline: none;">Чтобы активировать ваш аккаунт, пожалуйста, нажмите на ссылку ниже.</p>
	<p style="box-sizing: border-box; margin-top: 0; max-width: 100%; outline: none;"><a href="#" style="box-sizing: border-box; color: #4A90E2; max-width: 100%; outline: none; word-wrap: break-word;">https://www.vpnmax.org/web/user/confirm/83/PsdwLqgolG..</a></p>
	<h2 class="title" style="box-sizing: border-box; font-size: 32px; font-weight: 600; line-height: lh(40.25, 35); max-width: 100%; outline: none;">Код активации: <span class="noaccent" style="box-sizing: border-box; color: #fff; font-size: light; max-width: 100%; outline: none;">795825</span></h2>
	<p style="box-sizing: border-box; margin-top: 0; max-width: 100%; outline: none;">Если вы не можете нажать на ссылку, скопируйте ее и вставьте в адресную строку вашего браузера.</p>
	<p style="box-sizing: border-box; margin-bottom: 0; margin-top: 0; max-width: 100%; outline: none;">P.S. Если вы получили это сообщение<br style="box-sizing: border-box; max-width: 100%; outline: none;"> по ошибке, просто удалите его.</p>
</div>


<div class="footer" style="background: #232323; border-top: 1px solid #fff; box-sizing: border-box; max-width: 100%; outline: none; padding: 28px 50px; width: 100%;">
