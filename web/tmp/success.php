	...
	<div class="success-header">
		<div class="container">
			<div class="success-header-wrap">
				...
				<h1 class="title-1 _blue">Спасибо за покупку</h1>
			</div>
		</div>
	</div>
			...
			<div class="success-app-wrap">
				...
				<div class="success-app-steps">
					<div class="success-app-step">
						<div class="success-app-title">Введите код из письма</div>
						<div class="success-app-description">
					...
					<div class="success-app-step">
						<div class="success-app-title">Нажмите «Подключиться»</div>
						<div class="success-app-description">
							Ваш IP-адрес стал анонимным, а<br>
							соединение зашифровано
						</div>
					</div>

					<div class="success-app-step">
						<div class="success-app-title">Настройте автозапуск VPN</div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="success-video-wrap">
				...
				<div class="success-video-block">
					<div class="success-video-play"><img src="img/icons/play.svg"></div>
	...
	<div class="success-text">
		<div class="container">
			<div class="success-text-wrap">
				<ul>
					<li>
						Начните вводить название приложения – в нашем случае это Twitter<br>
