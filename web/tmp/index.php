...
<div class="container">
	<div class="header-intro">
		<div class="header-intro-img">
			<img src="img/header-intro-img.svg">
		</div>
		...
		<button class="btn-2" data-mfp-src='question'>Попробовать бесплатно</button>
	</div>
</div>
		...
		<div class="about-content">
			...
			<div class="about-items">
				...
				<div class="about-item">
					<div class="about-icon"><img src="img/about-1.svg"></div>
				...
				<div class="about-item">
					<div class="about-icon"><img src="img/about-2.svg"></div>
					<div class="about-text">
						Фоновый авто<br>
						запуск VPN
					</div>
				...
				<div class="about-item">
					<div class="about-icon"><img src="img/about-3.svg"></div>
					<div class="about-text">
						Большой выбор<br>
						стран
					</div>
				...
				<div class="about-item">
					<div class="about-icon"><img src="img/about-4.svg"></div>
					<div class="about-text">
				...
				<div class="about-item">
					<div class="about-icon"><img src="img/about-5.svg"></div>
					<div class="about-text">
						Шифрование<br>
						трафика
					</div>
				...
				<div class="about-item">
					<div class="about-icon"><img src="img/about-6.svg"></div>
					<div class="about-text">
						Доступ к любым<br>
						сайтам
					</div>
				...
				<div class="about-item">
					<div class="about-icon"><img src="img/about-7.svg"></div>
					<div class="about-text">
						Нет логов<br>
						на серверах
					</div>
				...
				<div class="about-item">
					<div class="about-icon"><img src="img/about-8.svg"></div>
					<div class="about-text">
						Безлимитный<br>
						трафик
					</div>
	...
	<div class="container">
		...
		<div class="steps-items">
			...
			<div class="steps-item _accent">
				<div class="steps-img"><img src="img/steps-img.svg"></div>
				<div class="steps-text">
		...
		<div class="feedbacks-rating-wrap">
			...
			<div class="feedbacks-rating">
				<div class="feedbacks-rating-img">
					<img src="img/feedbacks-rating-1.svg">
				</div>
					...
					<div class="stars">
						...
						<div class="stars-item">
							<svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M9 0L11.0206 6.21885H17.5595L12.2694 10.0623L14.2901 16.2812L9 12.4377L3.70993 16.2812L5.73056 10.0623L0.440492 6.21885H6.97937L9 0Z" fill="#00BDD7"/>
							</svg>
						</div>
						...
						<div class="stars-item">
							<svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path opacity="0.3" d="M9 0L11.0206 6.21885H17.5595L12.2694 10.0623L14.2901 16.2812L9 12.4377L3.70993 16.2812L5.73056 10.0623L0.440492 6.21885H6.97937L9 0Z" fill="#00BDD7"/>
							</svg>
						</div>
			...
			<div class="feedbacks-rating">
				<div class="feedbacks-rating-img">
					<img src="img/feedbacks-rating-2.svg">
				</div>
					...
					<div class="swiper-slide">
						<div class="feedbacks-item">
							...
							<div class="feedbacks-text">
								Я настоятельно рекомендую @ProtonVPN как чрезвычайно безопасный VPN с отличной репутацией. И вы можете связать его с @ProtonMail, чтобы сделать вашу электронную почту конфиденциальной, вместо того, чтобы использовать Google или Yahoo и т. д. для очистки вашего почтового ящика и продажи ваших данных.
							</div>
						</div>
					</div>
...
<div class="auto">
	<div class="container">
		<div class="auto-wrap">
			<div class="auto-img"><img src="img/auto-img.svg"></div>
