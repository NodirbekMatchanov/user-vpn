			...
			<div class="prices-methods">
				...
				<div class="prices-methods-items">
					<label class="prices-methods-item">
						...
						<span class="prices-methods-img"><img src="img/modal-prices-1.png"></span>
					</label>
					<label class="prices-methods-item">
						<input type="radio" name='method' hidden>
						<span class="prices-methods-thumb"></span>
						<span class="prices-methods-img"><img src="img/modal-prices-2.png"></span>
					</label>
					<label class="prices-methods-item">
						<input type="radio" name='method' hidden>
						<span class="prices-methods-thumb"></span>
						<span class="prices-methods-img"><img src="img/modal-prices-3.png"></span>
					</label>
					<label class="prices-methods-item">
						<input type="radio" name='method' hidden>
						<span class="prices-methods-thumb"></span>
						<span class="prices-methods-img"><img src="img/modal-prices-4.png"></span>
					</label>
				</div>
			</div>
