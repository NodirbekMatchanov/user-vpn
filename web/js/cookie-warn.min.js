...
(function (h) {
    var f = function (a, b, c) {
        if (void 0 === b) {
            ...
            for (b = 0; b < e.length; b++) if (c = e[b].substr(0, e[b].indexOf("=")), d = e[b].substr(e[b].indexOf("=") + 1), c = c.replace(/^\s+|\s+$/g, ""), c == a) return d
    ...
    f(h) || (window[h] = {
        ...
        function () {
            ...
            ({
                ...
                content: "#cookieWarnBox {position:fixed;line-height:24px; bottom:0;left:0;right:0;background-color:#0063b0;color:#ffffff;opacity:0.9;text-align:center;padding:10px;font-size:12px;}#cookieWarnBox span {text-transform:uppercase;cursor:pointer;background-color:#f1f1f1;color:#1188ff;padding:3px 14px;margin-left:10px;}#cookieWarnBox span:hover {background-color:#fefefe;} #cookieWarnBox a {text-decoration:none;color:#1188ff;}" +
                    a,
                append: function () {
            ...
            g.setAttribute("style", a.box);
            c = '<span id="cookieWarnClose" style="align-self: center;" onclick="' + h + ".close(" + f + ');">' + c + "</span>";
            g.innerHTML = '<div class="text">' + b + (d && e ? ' <a target="_blank" href="' + d + '">' + e + "</a> " : "") + "</div>"  + c;
