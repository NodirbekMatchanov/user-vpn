...
<?php endif; ?>
            ...
            <?php if (!empty($accs->vpn)): ?>
                <div class="info">
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-col">
                            <div class="info-wrap">
                                <div class="info-value _password"
                                     data-value='<?= $accs->vpn->value ?>'><?= $accs->vpn->value ?></div>
                                <div class="info-actions">
    ...
    <div class="settings">
        <div class="container">
            ...
            <div class="settings-text">
                Поделитесь промо-ссылкой с Вашими друзьями <a
                        href="<?= "https://" . $domain . "?ref=" . ($accs->promocode ?? '') ?>"
                        target="_blank"><?= "https://" . $domain . "?ref=" . ($accs->promocode ?? '') ?></a>
                За каждого кто зарегистрируется и оплатит подписку, Вы получите 7 дней использования VPN в подарок
                <div>Вашей рекомендации зарегистировалось <?= $registratedCount ?> человек из них купили
                    подскику <?= $payoutCount ?>   </div>
            </div>
...
<?php if (!empty($subscribe)): ?>
    <div class="settings">
        <div class="container">
            <h3 class="title-3">Подписка</h3>

            <div class="settings-text">
                Подписка на <?=$subscribe->tariff?>
            </div>
            <br>
            <?= Html::a(Yii::t('user', 'Удалить подписку'), ['cancel-subscribe'], [
                'class' => 'btn-2 _outline _silver',
                'data-method' => 'post',
                'data-confirm' => Yii::t('user', 'Are you sure? There is no going back'),
            ]) ?>
