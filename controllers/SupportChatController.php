...
use app\models\SupportChatSearch;
...
class SupportChatController extends Controller
{
    ...
    {
        $searchModel = new SupportChatSearch();
    ...
    /**
     * Creates a new SupportChat model.
    ...
    /**
     * Updates an existing SupportChat model.
    ...
    {
        if (($model = SupportChat::findOne(['id' => $id])) !== null) {
            return $model;
        }
