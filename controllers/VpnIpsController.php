...
class VpnIpsController extends Controller
{
    ...
    /**
     * Displays a single VpnIps model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Updates an existing VpnIps model.
    ...
    /**
     * Deletes an existing VpnIps model.
    ...
    /**
     * Finds the VpnIps model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return VpnIps the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = VpnIps::findOne(['id' => $id])) !== null) {
            return $model;
        }
